  ...
  overlay.innerHTML =
    '<div class="modal" style="max-width:440px">' +
      ...
      '<div style="display:flex;flex-wrap:wrap;gap:8px;justify-content:center;margin-bottom:16px">' +
        ...
        '<a href="https://discord.com/channels/@me" onclick="copyToClipboard(\'' + url.replace(/'/g, "\\'") + '\');showToast(\'Link copied — paste it in Discord\');return true;" target="_blank" rel="noopener" style="display:flex;flex-direction:column;align-items:center;gap:4px;text-decoration:none;color:var(--text);font-size:0.72rem;padding:8px 10px;border-radius:var(--radius);border:1px solid var(--border);min-width:56px">' +
