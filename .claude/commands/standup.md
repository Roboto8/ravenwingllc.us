...
6. **Recommend**: end with "Do today:" — the 1-3 highest-leverage actions, e.g. "send the drafted reply to X", "batch N goes out automatically at 7am, nothing needed", "investigate bounce from Y".
